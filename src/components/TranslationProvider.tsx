...
const enTranslations = {
  ...
  'register.verifyPhone': 'Verify Phone',
  'register.joinUs': 'Join us and start your herbal journey',
  'register.otpSentTo': 'Enter the OTP sent to',
  ...
  'register.phoneHint': 'Without +91 or spaces (e.g. 9876543210)',
  'register.password': 'Password',
  'register.passwordHint': 'Create a password (min 6 chars)',
  'register.confirmPassword': 'Confirm Password',
  'register.confirmPasswordHint': 'Confirm your password',
  'register.registerButton': 'Create Account',
  'register.creatingAccount': 'Creating Account...',
  'register.haveAccount': 'Already have an account?',
  'register.login': 'Sign In',
  'register.enterOtp': 'Enter OTP',
  'register.otpPlaceholder': 'Enter 6-digit OTP',
  'register.verifyComplete': 'Verify & Complete',
...
const taTranslations = {
  ...
  'register.verifyPhone': 'தொலைபேசியை சரிபார்க்கவும்',
  'register.joinUs': 'எங்களுடன் சேர்ந்து உங்கள் மூலிகை பயணத்தை தொடங்குங்கள்',
  'register.otpSentTo': 'OTP அனுப்பப்பட்டது',
  'register.name': 'முழு பெயர்',
  'register.namePlaceholder': 'உங்கள் முழு பெயரை உள்ளிடவும்',
  'register.email': 'மின்னஞ்சல் முகவரி',
  'register.emailPlaceholder': 'உங்கள் மின்னஞ்சலை உள்ளிடவும்',
  'register.phone': 'தொலைபேசி எண்',
  'register.phonePlaceholder': '10 இலக்க மொபைல் எண்',
  'register.phoneHint': '+91 அல்லது இடைவெளி இல்லாமல் (எ.கா. 9876543210)',
  'register.password': 'கடவுச்சொல்',
  'register.passwordHint': 'கடவுச்சொல் உருவாக்கவும் (குறைந்தது 6 எழுத்துகள்)',
  'register.confirmPassword': 'கடவுச்சொல்லை உறுதிப்படுத்தவும்',
  'register.confirmPasswordHint': 'உங்கள் கடவுச்சொல்லை உறுதிப்படுத்தவும்',
  'register.registerButton': 'கணக்கை உருவாக்கவும்',
  'register.creatingAccount': 'கணக்கை உருவாக்குகிறோம்...',
  'register.haveAccount': 'ஏற்கனவே கணக்கு உள்ளதா?',
  'register.login': 'உள்நுழைய',
  'register.enterOtp': 'OTP உள்ளிடவும்',
  'register.otpPlaceholder': '6 இலக்க OTP உள்ளிடவும்',
  'register.verifyComplete': 'சரிபார்த்து முடிக்கவும்',
  'register.verifying': 'சரிபார்க்கிறோம்...',
  'register.back': 'பின்னால்',
  'register.resendOtp': 'OTP மீண்டும் அனுப்பவும்',
